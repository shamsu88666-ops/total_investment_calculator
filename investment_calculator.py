...
with st.sidebar:
    ...
    st.markdown("SIP investments made at beginning of month Returns compounded monthly using **effective rate** Inflation not considered")            ['Expected Annual Return (%)', results['expected_return'] / 100]
        ]
